...
def index():
    ...
    saved_sorted_deck = copy.deepcopy(sorted_deck) #create save of sorted deck to display entire deck
    sorted_deck_draw_card = sorted_deck.remove_card()
    #print("sorted_deck_draw_card "+str(sorted_deck_draw_card))

    shuffled_deck = Deck()
    shuffled_deck.shuffle() #save for displaying because remove_card takes it out of array
